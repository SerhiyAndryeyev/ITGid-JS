...
function t11() {
  let str = '';
  divs11 = document.getElementsByClassName('div-11');
...
function t14() {
  let rbtns = document.getElementsByClassName('i-14');
  for (let i = 0; i < rbtns.length; i++) {
    if (rbtns[i].checked) {
      document.getElementsByClassName('out-14')[0].textContent = rbtns[i].value;
      break;
    }
  }
}
