...
function f3() {
  ...
  let a32 = +document.querySelector('.i-32').value;
  if (a31 > a32) {
...
function f4() {
  ...
  document.querySelector('.out-4').innerHTML = +(2021 - num > 18);
}
...
function f7() {
  let num = document.querySelector('.i-71').value;
  let pow = document.querySelector('.i-72').value;
