...
function t3(event) {
  document.querySelector('.out-3').textContent = event.target.textContent;
}
...
function t4(event) {
  document.querySelector('.div-4').addEventListener('touchstart', f4);
}
...
function t5(event) {
  document.querySelector('.div-4').removeEventListener('touchstart', f4);
}
...
function t7() {
  document.querySelector('.div-7').classList.add('isRed');
}
...
function t8(event) {
  ...
  document.querySelector('.div-8').style.background = `${randomColor}`;
}
...
function t11(event) {
  ...
  let out11 = `radiusX is: ${rX}<br>radiusY is: ${rY}`;
