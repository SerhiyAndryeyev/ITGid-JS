...
function t2() {
  return a2_res = a2.map(item => item * item);
}
...
function t3() {
  return a3_res = a3.map(item => Number(item));
}
...
function t4() {
  return a4_res = a4.filter(item => typeof (item) === "number");
}
...
function t5() {
  return a5_res = a5.filter(item => typeof (item) === 'number' && item % 2 === 0);
}
...
function t6() {
  return a6_res = a6.filter(item => typeof (item) === 'number' && item > 14);
}
...
function t10() {
  let a10_res = [];
  a10.forEach(item => a10_res.push(item < 0 ? 0 : item));
  a10 = a10_res;
  return a10;
}
...
function t14() {
  return a14.includes(a14_sym) || a14.includes(a14_sym.toLowerCase());
}
