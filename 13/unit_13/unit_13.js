...
function f6() {
  let key6 = document.querySelector('.i-61').value;
  let val6 = document.querySelector('.i-62').value;
  a6[key6] = [val6];
  f5(a6, '.out-6');
}
...
function f7() {
  let key7 = document.querySelector('.i-7').value;
  document.querySelector('.out-7').textContent = +(key7 in a7);
}
...
function f8() {
  let key8 = document.querySelector('.i-8').value;
  if (a8.hasOwnProperty(key8)) {
    out8.textContent = a8[key8];
...
function f18() {
  ...
  if (a18[inp18] != undefined) {
    for (let i = 0; i < a18[inp18].length; i++) {
      out += a18[inp18][i] + ' ';
      console.log(a18[inp18][i]);
    }
  }
  console.log(out);
...
function f19() {
  ...
  let inp19New = inp19.trim().toLowerCase();
  let inp19Finished = inp19New.charAt().toUpperCase() + inp19New.slice(1);
  for (let key in a19) {
    for (let i = 0; i < a19[key].length; i++) {
      if (a19[key][i] === inp19Finished) out = key;
    }
  }
