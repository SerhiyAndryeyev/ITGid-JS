...
function t8() {
  const inputT8 = document.querySelector('.i-8');
  let data = inputT8.value; // получили значение
...
function t9() {
  ...
  document.querySelector('.out-9').innerHTML = inputT9.value;
  inputT9.value = '';
}
...
function t10() {
  ...
  document.querySelector('.out-10').innerHTML = inputT10.value * 20;
}
...
function t11() {
  ...
  document.querySelector('.out-11').innerHTML = inputT11.value + 55;
}
...
function t12() {
  const inputT121 = document.querySelector('.i-12-1');
  const inputT122 = document.querySelector('.i-12-2');
  const out12 = document.querySelector('.out-12');
  out12.innerHTML = 'Hello ' + inputT121.value + ' ' + inputT122.value;
}
...
function t16() {
  let input1Value = document.querySelector('.i-16-1').value;
  let input2Value = document.querySelector('.i-16-2').value;
  document.querySelector('.out-16').innerHTML = input1Value + input2Value;
}
