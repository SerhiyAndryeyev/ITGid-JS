...
function f4() {
  let chbx = document.querySelector('.i-4');
  let result = false;
  if (chbx.checked) result = true;
...
function f5() {
  let result = false;
  let chbx = document.querySelector('.i-5');
  if (chbx.checked) result = chbx.value;
...
function f6() {
  const vl = document.querySelector('.i-6').value;
  document.querySelector('.out-6').textContent = vl;
}
...
function f7() {
  ...
  let result = 0;
  if (val.length >= 6) result = 1;
  document.querySelector('.out-71').textContent = val;
  document.querySelector('.out-72').textContent = result;
}
...
function f8() {
  const newDiv = '<div class="js2">new div</div>';
  document.querySelector('.out-8').innerHTML += newDiv;
}
...
function f9() {
  let result = false;
  let rbtn = document.querySelector('.r-9');
  if (rbtn.checked) result = rbtn.value;
...
function f10() {
  ...
  out10.style.backgroundColor = color;
}
...
function f16() {
  ...
  document.querySelector('.out-16').textContent = sel;
}
...
function f17() {
  ...
  document.querySelector('.out-17').textContent = sel;
}
...
function f18() {
  ...
  document.querySelector('.i-18').value = sel;
}
