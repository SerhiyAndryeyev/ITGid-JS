...
let ar1 = [5, 9, 'yes', 'no', false, 73, 1, 'good', 'bad', true, 90, 'great day', 3, 87];
...
let ar2 = [45, 19, 'yes', 'no', false, 73, 6, 'good', 'bad', true, 90, 'great day', 3];
...
let ar3 = [5, 9, 'yes', 'no', false, 73, 1, 'good', 'bad', true, 90, 'great day', 3, 871, 7, 'sdsds'];
...
let ar4 = [5, 9, 'yes', 'no', false, 73, 1, 'good', 'bad', true, 90, 'great day', 3, 871, 7, 'sdsds'];
...
function f17() {
  ...
  document.querySelector('.out-17').textContent = num;
}
...
function f19() {
  ...
  document.querySelector('.out-19').textContent = index;
}
